...
export default function PostsPage() {
    ...
    // This client uses LocalStorage which appears to have the valid session
    // const supabase = createBrowserClient(...) // Removed

    // Note: 'supabase' is imported from '@/lib/supabase'
    ...
    const loadInstagramPosts = async () => {
        ...
        try {
            ...
            if (!session) {
                console.log('No session found via lib/supabase')
                return
            }
